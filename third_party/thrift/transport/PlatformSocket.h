...
#ifndef _GORGONZOLA_THRIFT_TRANSPORT_PLATFORM_SOCKET_H_
#  define _GORGONZOLA_THRIFT_TRANSPORT_PLATFORM_SOCKET_H_
...
#endif // _GORGONZOLA_THRIFT_TRANSPORT_PLATFORM_SOCKET_H_
