...
#ifndef _GORGONZOLA_THRIFT_TRANSPORT_TVIRTUALTRANSPORT_H_
#define _GORGONZOLA_THRIFT_TRANSPORT_TVIRTUALTRANSPORT_H_ 1
...
public:
  ...
  uint32_t readAll(uint8_t* buf, uint32_t len) {
    ...
    return ::gorgonzola_apache::thrift::transport::readAll(*trans, buf, len);
  }
...
#endif // #ifndef _GORGONZOLA_THRIFT_TRANSPORT_TVIRTUALTRANSPORT_H_
