...
typedef struct {
    ...
    uint32_t thread_qos;
#endif
} gorgonzola_system_config;

/**
 * @brief gorgonzola_database manages all database components.
 */
typedef struct {
    void* _database;
} gorgonzola_database;
...
/**
 * @brief gorgonzola_connection is used to interact with a Database instance. Each connection is
...
typedef struct {
    ...
    void* _bound_values;
} gorgonzola_prepared_statement;

/**
 * @brief gorgonzola_query_result stores the result of a query.
 */
typedef struct {
    void* _query_result;
    bool _is_owned_by_cpp;
} gorgonzola_query_result;

/**
 * @brief gorgonzola_flat_tuple stores a vector of values.
 */
typedef struct {
    void* _flat_tuple;
    bool _is_owned_by_cpp;
} gorgonzola_flat_tuple;

/**
 * @brief gorgonzola_logical_type is the gorgonzola internal representation of data types.
 */
typedef struct {
    void* _data_type;
} gorgonzola_logical_type;

/**
 * @brief gorgonzola_value is used to represent a value with any gorgonzola internal dataType.
 */
typedef struct {
    void* _value;
    bool _is_owned_by_cpp;
...
/**
 * @brief gorgonzola internal internal_id type which stores the table_id and offset of a node/rel.
 */
typedef struct {
    uint64_t table_id;
    uint64_t offset;
...
typedef struct {
    // Microseconds since 1970-01-01 00:00:00 UTC.
    int64_t value;
} gorgonzola_timestamp_t;

/**
 * @brief gorgonzola internal interval type which stores the months, days and microseconds.
 */
typedef struct {
    int32_t months;
    int32_t days;
...
/**
 * @brief enum class for gorgonzola internal dataTypes.
 */
typedef enum {
    GORGONZOLA_ANY = 0,
    GORGONZOLA_NODE = 10,
    GORGONZOLA_REL = 11,
    GORGONZOLA_RECURSIVE_REL = 12,
    ...
    GORGONZOLA_INT16 = 25,
    GORGONZOLA_INT8 = 26,
    GORGONZOLA_UINT64 = 27,
    GORGONZOLA_UINT32 = 28,
    GORGONZOLA_UINT16 = 29,
    GORGONZOLA_UINT8 = 30,
    GORGONZOLA_INT128 = 31,
    GORGONZOLA_DOUBLE = 32,
    GORGONZOLA_FLOAT = 33,
    GORGONZOLA_DATE = 34,
    GORGONZOLA_TIMESTAMP = 35,
    GORGONZOLA_TIMESTAMP_SEC = 36,
    GORGONZOLA_TIMESTAMP_MS = 37,
    GORGONZOLA_TIMESTAMP_NS = 38,
    GORGONZOLA_TIMESTAMP_TZ = 39,
    GORGONZOLA_INTERVAL = 40,
    GORGONZOLA_DECIMAL = 41,
    GORGONZOLA_INTERNAL_ID = 42,
    // variable size types
    GORGONZOLA_STRING = 50,
    GORGONZOLA_BLOB = 51,
    GORGONZOLA_LIST = 52,
    GORGONZOLA_ARRAY = 53,
    GORGONZOLA_STRUCT = 54,
    GORGONZOLA_MAP = 55,
    GORGONZOLA_UNION = 56,
    GORGONZOLA_POINTER = 58,
    GORGONZOLA_UUID = 59
} gorgonzola_data_type_id;

/**
 * @brief enum class for gorgonzola function return state.
 */
typedef enum { GorgonzolaSuccess = 0, GorgonzolaError = 1 } gorgonzola_state;
 ...
 */
GORGONZOLA_C_API gorgonzola_state gorgonzola_database_init(const char* database_path,
    gorgonzola_system_config system_config, gorgonzola_database* out_database);
/**
 * @brief Destroys the gorgonzola database instance and frees the allocated memory.
 * @param database The database instance to destroy.
 */
GORGONZOLA_C_API void gorgonzola_database_destroy(gorgonzola_database* database);

GORGONZOLA_C_API gorgonzola_system_config gorgonzola_default_system_config();

// Connection
/**
 * @brief Allocates memory and creates a connection to the database. Caller is responsible for
 * calling gorgonzola_connection_destroy() to release the allocated memory.
 ...
 * @return The state indicating the success or failure of the operation.
 */
GORGONZOLA_C_API gorgonzola_state gorgonzola_connection_init(gorgonzola_database* database,
    gorgonzola_connection* out_connection);
/**
 * @brief Destroys the connection instance and frees the allocated memory.
 * @param connection The connection instance to destroy.
 */
GORGONZOLA_C_API void gorgonzola_connection_destroy(gorgonzola_connection* connection);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
GORGONZOLA_C_API gorgonzola_state gorgonzola_connection_execute(gorgonzola_connection* connection,
 ...
 */
GORGONZOLA_C_API void gorgonzola_connection_interrupt(gorgonzola_connection* connection);
/**
 ...
 */
GORGONZOLA_C_API char* gorgonzola_prepared_statement_get_error_message(
 ...
 * @return The state indicating the success or failure of the operation.
 */
GORGONZOLA_C_API gorgonzola_state gorgonzola_prepared_statement_bind_int64(
    gorgonzola_prepared_statement* prepared_statement, const char* param_name, int64_t value);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
GORGONZOLA_C_API gorgonzola_state gorgonzola_prepared_statement_bind_int32(
    gorgonzola_prepared_statement* prepared_statement, const char* param_name, int32_t value);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
GORGONZOLA_C_API gorgonzola_state gorgonzola_prepared_statement_bind_int16(
    gorgonzola_prepared_statement* prepared_statement, const char* param_name, int16_t value);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
GORGONZOLA_C_API gorgonzola_state gorgonzola_prepared_statement_bind_uint64(
    gorgonzola_prepared_statement* prepared_statement, const char* param_name, uint64_t value);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
GORGONZOLA_C_API gorgonzola_state gorgonzola_prepared_statement_bind_uint32(
    gorgonzola_prepared_statement* prepared_statement, const char* param_name, uint32_t value);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
GORGONZOLA_C_API gorgonzola_state gorgonzola_prepared_statement_bind_uint16(
    gorgonzola_prepared_statement* prepared_statement, const char* param_name, uint16_t value);
/**
 * @brief Binds the given int8_t value to the given parameter name in the prepared statement.
 * @param prepared_statement The prepared statement instance to bind the value.
 * @param param_name The parameter name to bind the value.
 ...
 * @return The state indicating the success or failure of the operation.
 */
GORGONZOLA_C_API gorgonzola_state gorgonzola_prepared_statement_bind_uint8(
    gorgonzola_prepared_statement* prepared_statement, const char* param_name, uint8_t value);
 ...
 * @return The state indicating the success or failure of the operation.
 */
GORGONZOLA_C_API gorgonzola_state gorgonzola_prepared_statement_bind_double(
    gorgonzola_prepared_statement* prepared_statement, const char* param_name, double value);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
GORGONZOLA_C_API gorgonzola_state gorgonzola_prepared_statement_bind_float(
    gorgonzola_prepared_statement* prepared_statement, const char* param_name, float value);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
GORGONZOLA_C_API gorgonzola_state gorgonzola_prepared_statement_bind_timestamp_sec(
    gorgonzola_prepared_statement* prepared_statement, const char* param_name,
    gorgonzola_timestamp_sec_t value);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
GORGONZOLA_C_API gorgonzola_state gorgonzola_prepared_statement_bind_string(
    gorgonzola_prepared_statement* prepared_statement, const char* param_name, const char* value);
/**
 * @brief Binds the given gorgonzola value to the given parameter name in the prepared statement.
 * @param prepared_statement The prepared statement instance to bind the value.
 * @param param_name The parameter name to bind the value.
 * @param value The gorgonzola value to bind.
 * @return The state indicating the success or failure of the operation.
 */
 ...
 */
GORGONZOLA_C_API void gorgonzola_query_result_destroy(gorgonzola_query_result* query_result);
/**
 ...
 */
GORGONZOLA_C_API bool gorgonzola_query_result_is_success(gorgonzola_query_result* query_result);
/**
 ...
 */
GORGONZOLA_C_API char* gorgonzola_query_result_to_string(gorgonzola_query_result* query_result);
/**
 ...
 */
GORGONZOLA_C_API void gorgonzola_flat_tuple_destroy(gorgonzola_flat_tuple* flat_tuple);
/**
 ...
 */
GORGONZOLA_C_API char* gorgonzola_flat_tuple_to_string(gorgonzola_flat_tuple* flat_tuple);
 ...
 */
GORGONZOLA_C_API void gorgonzola_data_type_destroy(gorgonzola_logical_type* data_type);
/**
 ...
 */
GORGONZOLA_C_API gorgonzola_value* gorgonzola_value_create_null();
/**
 ...
 */
GORGONZOLA_C_API bool gorgonzola_value_is_null(gorgonzola_value* value);
/**
 ...
 */
GORGONZOLA_C_API void gorgonzola_value_set_null(gorgonzola_value* value, bool is_null);
/**
 ...
 */
GORGONZOLA_C_API gorgonzola_value* gorgonzola_value_create_bool(bool val_);
/**
 ...
 */
GORGONZOLA_C_API gorgonzola_value* gorgonzola_value_create_int8(int8_t val_);
/**
 ...
 */
GORGONZOLA_C_API gorgonzola_value* gorgonzola_value_create_int16(int16_t val_);
/**
 ...
 */
GORGONZOLA_C_API gorgonzola_value* gorgonzola_value_create_int32(int32_t val_);
/**
 ...
 */
GORGONZOLA_C_API gorgonzola_value* gorgonzola_value_create_int64(int64_t val_);
/**
 ...
 */
GORGONZOLA_C_API gorgonzola_value* gorgonzola_value_create_uint8(uint8_t val_);
/**
 ...
 */
GORGONZOLA_C_API gorgonzola_value* gorgonzola_value_create_uint16(uint16_t val_);
/**
 ...
 */
GORGONZOLA_C_API gorgonzola_value* gorgonzola_value_create_uint32(uint32_t val_);
/**
 ...
 */
GORGONZOLA_C_API gorgonzola_value* gorgonzola_value_create_uint64(uint64_t val_);
/**
 ...
 */
GORGONZOLA_C_API gorgonzola_value* gorgonzola_value_create_int128(gorgonzola_int128_t val_);
/**
 ...
 */
GORGONZOLA_C_API gorgonzola_value* gorgonzola_value_create_float(float val_);
/**
 ...
 */
GORGONZOLA_C_API gorgonzola_value* gorgonzola_value_create_double(double val_);
/**
 ...
 */
GORGONZOLA_C_API gorgonzola_value* gorgonzola_value_create_date(gorgonzola_date_t val_);
/**
 ...
 */
GORGONZOLA_C_API gorgonzola_value* gorgonzola_value_create_timestamp(gorgonzola_timestamp_t val_);
/**
 ...
 */
GORGONZOLA_C_API gorgonzola_value* gorgonzola_value_create_interval(gorgonzola_interval_t val_);
/**
 ...
 */
GORGONZOLA_C_API gorgonzola_value* gorgonzola_value_create_string(const char* val_);
/**
 ...
 */
GORGONZOLA_C_API gorgonzola_value* gorgonzola_value_clone(gorgonzola_value* value);
/**
 * @brief Copies the other value to the value.
 * @param value The value to copy to.
 * @param other The value to copy from.
 */
GORGONZOLA_C_API void gorgonzola_value_copy(gorgonzola_value* value, gorgonzola_value* other);
/**
 * @brief Destroys the value.
 * @param value The value to destroy.
 */
GORGONZOLA_C_API void gorgonzola_value_destroy(gorgonzola_value* value);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
GORGONZOLA_C_API gorgonzola_state gorgonzola_value_get_timestamp_ns(gorgonzola_value* value,
 ...
 * @return The state indicating the success or failure of the operation.
 */
GORGONZOLA_C_API gorgonzola_state gorgonzola_value_get_timestamp_ms(gorgonzola_value* value,
 ...
 * @return The state indicating the success or failure of the operation.
 */
GORGONZOLA_C_API gorgonzola_state gorgonzola_value_get_timestamp_sec(gorgonzola_value* value,
 ...
 * @return The state indicating the success or failure of the operation.
 */
GORGONZOLA_C_API gorgonzola_state gorgonzola_value_get_timestamp_tz(gorgonzola_value* value,
 ...
 */
GORGONZOLA_C_API char* gorgonzola_value_to_string(gorgonzola_value* value);
/**
 * @brief Returns the internal id value of the given node value as a gorgonzola value.
...
/**
 * @brief Destroys any blob created by the Gorgonzola C API. This function is provided to avoid the
 ...
 */
GORGONZOLA_C_API void gorgonzola_destroy_blob(uint8_t* blob);
 ...
 */
GORGONZOLA_C_API void gorgonzola_query_summary_destroy(gorgonzola_query_summary* query_summary);
/**
...
// Version
/**
 * @brief Returns the version of the Gorgonzola library.
 */
GORGONZOLA_C_API char* gorgonzola_get_version();

/**
 * @brief Returns the storage version of the Gorgonzola library.
 */
GORGONZOLA_C_API uint64_t gorgonzola_get_storage_version();
#undef GORGONZOLA_C_API
