...
class GORGONZOLA_API Extension {
public:
...
struct GORGONZOLA_API ExtensionUtils {
    static constexpr const char* OFFICIAL_EXTENSION_REPO = "http://extension.gorgonzoladb.com/";
    static constexpr const char* EXTENSION_FILE_SUFFIX = "gorgonzola_extension";
...
class GORGONZOLA_API ExtensionLibLoader {
public:
