...
py::object PyQueryResult::convertValueToPyObject(const Value& value) {
    ...
    case LogicalTypeID::INT128: {
        ...
        std::string int128_string = gorgonzola::common::Int128_t::toString(result);
...
gorgonzola::pyarrow::Table PyQueryResult::getAsArrow(std::int64_t chunkSize,
    bool fallbackExtensionTypes) {
    ...
    return py::cast<gorgonzola::pyarrow::Table>(fromBatchesFunc(batches, schemaObj));
}
